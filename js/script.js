...
if (document.body.classList.contains("_touch") && !document.querySelector("._page-admin")) {
...
if (document.querySelector(".preloader")) {
    ...
    window.addEventListener("load", function(e) {
        ...
        // Скролл к нужному элементу на странице "О нас" после перехода по "клику" на одну из карточек слайдера "команда":
